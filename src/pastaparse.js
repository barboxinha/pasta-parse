...
let pastaparse = {
     ...
     * @example
     * 
     * pastaparse.convertFractionToFloat('1/2');
     * // => 0.5
     * 
     * pastaparse.convertFractionToFloat('1/4');
     * // => 0.25
     * 
     * pastaparse.convertFractionToFloat('5/8');
     * // => 0.625
     * 
     * pastaparse.convertFractionToFloat('3 3/4');
     * // => 3.75
     */
